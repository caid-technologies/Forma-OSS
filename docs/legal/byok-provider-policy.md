...
| Cloudflare AI | Disabled | Enabled | Enabled | Hosted BYOK remains disabled until provider terms and API-token scopes are reviewed. Local and self-hosted users may supply `CLOUDFLARE_API_TOKEN`. |
