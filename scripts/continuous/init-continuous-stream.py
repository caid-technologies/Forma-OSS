...
from blueprint_core.agents.continuous import ContinuousAgentState, JsonlStreamStore, utc_now
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("[init-continuous-stream] listen: ./scripts/continuous/listen-continuous-stream.py --stream-id " + store.stream_id)
    print("[init-continuous-stream] run agents: ./scripts/continuous/run-continuous-agents.py --stream-id " + store.stream_id)
    return 0
