...
- lithium battery packs, battery charging, or power systems without appropriate protection and qualified review;
- medical, automotive, aviation, industrial, public infrastructure, or life-safety systems;
- weapons, harmful devices, or safety bypasses;
- commercial products without formal engineering, testing, and certification.

## 3. Required Independent Checks

Before purchasing parts or building anything, verify:

- datasheets and manufacturer application notes;
- voltage, current, power, temperature, connector, fuse, and wire ratings;
- pinouts, polarity, grounding, isolation, protection diodes, and regulator limits;
- battery chemistry, charging, protection, enclosure, ventilation, and thermal behavior;
- mechanical tolerances, materials, fasteners, moving parts, pinch points, and enclosure safety;
- regulatory and certification obligations, such as electrical safety, EMC, radio, battery transport, environmental, labeling, and product liability rules.

## 4. Safe Testing Practices

Use safe lab practices, including current-limited bench supplies, fuses, insulated tools, eye protection, ventilation, fire-safe charging areas, emergency shutoff, and appropriate supervision. Keep prototypes away from children, flammable materials, water, and unattended operation unless a qualified reviewer confirms the design is safe for that context.
