...
export const metadata: Metadata = {
  ...
  description: "About CAID Technologies, Blueprint, partners, and legal resources.",
};
      ...
      <main className="min-h-screen bg-[#141519] px-5 py-5 font-sans text-slate-100">
        ...
        <section className="mx-auto grid w-full max-w-6xl gap-8 py-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-semibold leading-tight text-white sm:text-6xl">About Blueprint</h1>
          </div>
          <div className="max-w-2xl text-base leading-7 text-slate-400 lg:justify-self-end">
            Blueprint helps builders turn early hardware ideas into structured project plans with parts, wiring, validation, build notes, and generated artifacts.
        ...
        <section className="mx-auto grid w-full max-w-6xl gap-3 pb-10 md:grid-cols-3">
          ...
          <div className="border border-[#2c2f37] bg-[#17181d] p-5">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-500">Blueprint keeps safety constraints, validation notes, and known unknowns visible in the workflow.</p>
          </div>
          <div className="border border-[#2c2f37] bg-[#17181d] p-5">
