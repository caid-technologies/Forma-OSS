...
| Nebius Token Factory | Disabled | Enabled | Enabled | Hosted BYOK remains disabled until provider terms and API-key scopes are reviewed. Local and self-hosted users may supply `NEBIUS_API_KEY`. |
