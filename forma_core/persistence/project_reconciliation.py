...
def _reconcile_generated(
    ...
    *,
    ...
    values = _identity_values(
        ...
        project.chat_id,
        None,
        str(project.visibility or "private"),
    ...
    projection_values = {
        ...
        "visibility": str(canonical_identity.visibility or "private"),
            ...
            if canonical_id is None:
                ...
                if identity is not None and _owner(identity.get("owner_user_id")) not in (None, owner):
                    ...
                    values = _identity_values(
                        ...
                        str(source.get("visibility") or "private"), str(source.get("status") or "active"),
                    ...
                    projection = {
                        ...
                        "visibility": canonical_identity.get("visibility") or "private",
