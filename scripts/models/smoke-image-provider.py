...
def main() -> int:
    ...
    parser.add_argument("--user-id", default=config.get("FORMA_TEST_USER_ID") or config.get("FORMA_USER_ID"), help="Clerk user id whose saved BYOK settings should be loaded.")
