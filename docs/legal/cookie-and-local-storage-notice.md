...
- store local chat or project drafts in your browser;
- support integrations and UI state;
- measure usage, diagnose errors, and improve reliability;
- prevent abuse, fraud, and unauthorized access;
- support optional analytics or marketing if enabled.
...
Questions about this notice can be sent to team@caid-technologies.com.
